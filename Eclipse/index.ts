...
const NFT_DETAILS = {
    ...
    symbol: "sb",
    royalties: 500,
    description: 'solo stepping nft, Guide by ZunXBT',
    imgType: 'image/jpg',
    attributes: [
...
const PINATA_API_KEY = 'de672d372037b0b5f7b4'; // 👈 Replace with your Pinata API key
const PINATA_SECRET_KEY = 'aab4bc60df601cccc892ad4eea3481c5b0765534829ef0b4a0731ed183b8f449'; // 👈 Replace this with your IPFS API endpoint
const umi = createUmi(CLUSTERS.mainnet, OPTIONS.confirm).use(niftyAsset()); // 👈 Replace this with your cluster
